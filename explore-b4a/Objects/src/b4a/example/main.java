...
RDebugUtils.currentLine=327681;
 //BA.debugLineNum = 327681;BA.debugLine="xui.MsgboxAsync(\"Coba Merubah Message Box\", \"B4X\"";
_xui.MsgboxAsync(processBA,BA.ObjectToCharSequence("Coba Merubah Message Box"),BA.ObjectToCharSequence("B4X"));
